 ...
 * 
 * 
 * A layout concept should also provide a means at hinting at an efficient
 * traversal of the elements in the underlying 1d-array, most likely by
 * exploiting locality of reference, e.g., if layout is zxy and then 
