...
The Bernoulli Model is a general framework for thinking about probabilistic data structures and types of a particular sort. A major motivation for developing the Bernoulli Model formalism is to use it as a foundation for creating Oblivious Data Types. The basic idea is that Bernoulli approximations have desirable properties for developing oblivious data types, and the formalism allows for reasoning about their correctness while making them more space-efficient by trading accuracy for space, all while maintaining $\mathcal{O}(1)$ time complexity.
